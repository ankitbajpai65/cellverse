...
const Vision = () => {
  ...
  return (
    <section className="py-16">
      <h1 className="text-5xl font-bold my-5 text-center mb-16">Our Vision</h1>

      <div className="h-96 max-h-fit w-full flex flex-col md:flex-row gap-16 justify-center items-center border-tl-full px-5 relative">
        <div
          style={{
            position: "absolute",
            top: 0,
      ...
      <div className="h-96 max-h-fit w-full flex flex-col-reverse md:flex-row gap-16 justify-center items-center border-tl-full px-5 mt-16 relative">
        <div
          className="bg-vision"
          style={{
            position: "absolute",
