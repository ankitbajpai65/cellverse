  ...
  return (
    <>
      <section className="h-[89vh] flex justify-start items-end text-white relative">
        ...
        <div className="flex flex-col gap-3 absolute bottom-24 left-16">
          <h1 className="text-2xl">Moving towards</h1>
          <div className="flex gap-3">
            <span className="text-5xl text-button font-bold">Animal</span>
            <span className="text-5xl font-bold">Free</span>
          </div>
          <h4 className="text-2xl font-semibold">Drug Discovery</h4>
        </div>
      </section>
      <div ref={visionRef}>
        <Vision />
